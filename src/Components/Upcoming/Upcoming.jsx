                  ...
                  <div className="container">
                    <div className="upcoming_box">
                      <div className="upcoming_card">
                        ...
                        >
                       Farovonlik va baxt qoʻnim topgan 
                       maskanda yashang
                        </h3>
                        <p className="slidet_text2">
                        Bibishox — TXT Group kompaniyasi tomonidan Urgut tumanida barpo
                        etilayotgan ko’p funksiyali, komfort toifadagi turar-joy majmuasi.
                        </p>
                      </div>
